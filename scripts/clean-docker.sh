...
function clean() {
  ...
  docker-machine ssh $DOCKER_MACHINE_NAME 'sudo rm -rf /tmp/volumes/postgres-follow'
  docker-machine ssh $DOCKER_MACHINE_NAME 'sudo mkdir -p /tmp/volumes/postgres-follow'
}
